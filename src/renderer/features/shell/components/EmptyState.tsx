    ...
    <>
      ...
      <div className="empty-state">
        <div className="empty-card">
          ...
          <h1>Add a project</h1>
          <p>
            Projects map to local folders. Tabs, splits, and shell sessions are tracked per project. Pick a folder to get started, or keep
            the built-in demo workspaces from a fresh install.
          </p>
          <button className="primary-button" onClick={() => void appActions.addWorkspaceFromFolder()}>
            Choose Folder
          </button>
        </div>
      </div>
